...
namespace PetProject.Migrations
{
    ...
    [Migration("20251213172103_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetProject.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("PetProject.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PetProject.Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("PetProject.Domain.Entities.ApplicationUser", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
